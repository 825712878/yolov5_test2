...
"""
goal:
1. figure out how the train.py work
2. learn the coding knowledge 
### attention:   本次目的最简单来说搞清楚本文件的使用方法
首先标签格式已经知晓 -->  class, 归一化(x, y, w, h)  txt
notebook 中 使用简单的 python  train.py + 若干参数即可运行本代码，但是仍无法知晓
1. 如何运作， 逻辑
2. 如何保存权重 .pth 文件
3. 如何衡量效果 
...
def parse_opt(known=False):
    ...
    parser.add_argument('--sync-bn', action='store_true', help='use SyncBatchNorm, only available in DDP mode(多gpu的BN)')
